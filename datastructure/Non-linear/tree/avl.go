...
func main() {
	avlT := AVLTree{&AVLNode{key: 12, Value: "sam"}}
	avlT.Add(14, "Dan")
	avlT.Add(16, "Newt")
	fmt.Println(avlT.root.left)
}
...
func (t *AVLTree) Update(oldKey int, newKey int, newValue string) {
...
// Adds a new node
func (n *AVLNode) add(key int, value string) *AVLNode {
	if n == nil {
